...
namespace Otus_Interfaces_Homework_6
{
    ...
    {
        ToDoUser RegisterUser(long telegramUserId, string telegramUserName);     //Метод регистрации новых пользователей.
        ToDoUser? GetUser(long telegramUserId);                                  //Метод получения уже зарегистрированного пользователя.
    }
}
